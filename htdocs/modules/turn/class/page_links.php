 ...
 * @package kernel
 */
class turnPage_links extends XoopsObject
{

	var $_ModConfig = NULL;
	var $_Mod = NULL;
	
    function turnPage_links($id = null)
    {
    ...
    function getForm() {
    	return turn_page_links_get_form($this, false);
    }
    
    function toArray() {
    	$ret = parent::toArray();
    	$ele = turn_page_links_get_form($this, true);
...
* @package kernel
*/
class turnPage_linksHandler extends XoopsPersistableObjectHandler
{
	...
	function __construct(&$db) 
    {
    	...
    	$this->db = $db;
        parent::__construct($db, 'turn_page_links', 'turnPage_links', "lid", "pids");
    }

 ...
 * @access 		public
 */
class turnFormSelectLanguage extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function turnFormSelectLanguage($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        if ($none==true)
        	$this->addOption('', _MI_TURN_NONE);
        $language_handler = xoops_getmodulehandler('xlanguage_ext', 'turn');
